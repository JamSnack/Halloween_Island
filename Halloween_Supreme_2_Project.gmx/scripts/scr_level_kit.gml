...
switch lvl
{
    ...
    case 5: { global.unlocked_attacks[battle_attack.smash] = 0; global.unlocked_attacks[battle_attack.destroy] = 1; } break;
    case 6: { global.unlocked_attacks[battle_attack.destroy] = 0; global.unlocked_attacks[battle_attack.remove_flesh] = 1; } break;
}
